...
<body class="bg-light">
						...
						<div class="row">
							...
							<div class="col-lg-6">
								...
								<div class="mb-4">
									...
									<iframe id="iframe" class="border p-2 w-100S" loading="lazy"></iframe>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="modal-body">
									<div class="container-fluid p-0">
										<div class="row">
											<div class="col-md-6">			
												...
												<div class="mb-3">
													...
													<div class="input-group mb-3">
														<span class="input-group-text"><i class="bi bi-telephone-fill"></i>vadlrik memek</span>
											...
											<div class="col-md-6">
												<div class="mb-3">
													<label  class="form-label fw-bold">Social LinksS</label>
													<div class="input-group mb-3">
														<span class="input-group-text"><i class="bi bi-twitter-x"></i></span>
														<input type="text" name="x" id="x_inp" class="form-control shadow-none" required>
													</div>
													<div class="input-group mb-3">
	...
	<script>
		...
		{
			let contacts_p_id = ['address','gmap','pn1','pn2','email','x','tt','ig'];
		...
		{
			let contacts_inp_id = ['address_inp','gmap_inp','pn1_inp','pn2_inp','email_inp','x_inp','tt_inp','ig_inp','iframe_inp'];
		...
		{
			let index = ['address','gmap','pn1','pn2','email','x','tt','ig','iframe'];
			let contacts_inp_id = ['address_inp','gmap_inp','pn1_inp','pn2_inp','email_inp','x_inp','tt_inp','ig_inp','iframe_inp'];
