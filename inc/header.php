    ...
    <div class="modal-content">
        <form>
            ...
            <div class="d-flex align-items-center justify-content-between mb-2">
                ...
                <a href="javacript: void(0)" class="text-secondary text-decoration-none">Forget Password?</a>
            </div>
          </div>
        </form>
    </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form>
            ...
            <div class="modal-body">
            <span class="badge rounded-pil bg-light text-dark mb-3 text-wrap lh-base">
              Note: Your details must match with your ID (KTP, Passport, SIM, etc.)
